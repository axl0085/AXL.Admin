...
namespace AXL.Admin.WebApi.Extensions {
    ...
    public static class SwaggerExtension {
        ...
        public static void UseSwagger(this IApplicationBuilder app) {
            ...
            app.UseSwaggerUI(c => c.SwaggerEndpoint("v1/swagger.json", "AXLAdmin v1"));
        }
        ...
        public static void AddSwaggerConfig(this IServiceCollection services) {
            ...
            services.AddSwaggerGen(c => {
                c.SwaggerDoc("v1", new OpenApiInfo {
                    Title = "DotNet Api - .NET7",
                    Version = "v1",
                    Description = "",
                });
                try {
                    //添加文档注释
                    c.IncludeXmlComments("AXLAdmin.xml", true);
                    c.IncludeXmlComments("AXLAdminDto.xml", true);
                }
                catch (Exception ex) {
